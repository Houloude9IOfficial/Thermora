...
export async function collectMacosDiagnostics(): Promise<DiagnosticCheck[]> {
...
export function createMacosAdapter(): PlatformAdapter {
  return {
    id: "macos",
    name: "macOS",
    capabilities: {
    ...
    installStartup,
    uninstallStartup,
    runDiagnostics: collectMacosDiagnostics,
  };
}
